import { cronJobGVK, deploymentConfigGVK, deploymentGVK, METADATA_ANNOTATION_APP_VERSION, METADATA_ANNOTATION_QUARKUS_BUILD_TIMESTAMP } from "./const";
...
export function getCamelIntegrationVersion(integration: CamelIntegrationKind): string | null {
